  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)]">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <h1 className="text-4xl font-bold text-white mb-4">Licensing</h1>
        <p className="text-sm text-slate-400 mb-8">Last updated: February 8, 2026</p>

        <div className="prose prose-invert prose-slate max-w-none space-y-6 text-slate-300">
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">1. Software License</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">2. License Types</h2>
            
            <h3 className="text-xl font-semibold text-white mt-6 mb-3">2.1 Individual License</h3>
            <p>
              Grants access to a single user for personal or professional use within their organization.
            </p>

            <h3 className="text-xl font-semibold text-white mt-6 mb-3">2.2 Team License</h3>
            <p>
              Grants access to multiple users within a single organization, with collaborative features and
              shared workspaces.
            </p>

            <h3 className="text-xl font-semibold text-white mt-6 mb-3">2.3 Enterprise License</h3>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">3. License Restrictions</h2>
            <p>You may not:</p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">4. Open Source Components</h2>
            <p>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="p-4 bg-slate-800/50 rounded-lg border border-slate-700">
                <h4 className="font-semibold text-white mb-2">Prisma</h4>
              ...
              <div className="p-4 bg-slate-800/50 rounded-lg border border-slate-700">
                <h4 className="font-semibold text-white mb-2">Tailwind CSS</h4>
                <p className="text-sm">License: MIT License</p>
                <p className="text-sm text-slate-400 mt-1">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">6. Proprietary Rights</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">7. Trademarks</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">8. License Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">9. Updates and Modifications</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">10. Export Compliance</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">11. Government Use</h2>
            <p>
