...
export function RiskRegisterTable() {
    ...
    const getCategoryColor = (category: string) => {
        ...
        if (cat.includes('critical')) return "bg-red-500/10 text-red-400 border-red-500/20";
        if (cat.includes('high')) return "bg-orange-500/10 text-orange-400 border-orange-500/20";
        if (cat.includes('medium')) return "bg-yellow-500/10 text-yellow-500 border-yellow-500/20";
                                    ...
                                    >
                                        ...
                                        <td className="p-4">
                                            <div className="flex flex-col gap-1">
                                                <div className="flex items-center gap-2">
                                                    <span className="font-mono text-xs font-bold text-blue-400 bg-blue-500/10 px-1.5 rounded">{risk.displayId}</span>
                                                    <span className={cn(
                                        ...
                                        <td className="p-4">
                                            <div className="flex justify-center gap-3 text-xs font-mono text-[var(--text-secondary)]">
                                                <div className="flex flex-col items-center">
                                                    ...
                                                    <span className={cn(risk.confidentiality >= 4 && "text-red-400 font-bold")}>{risk.confidentiality}</span>
                                                </div>
                                                <div className="flex flex-col items-center">
                                                    <span className="text-[10px] uppercase text-[var(--text-muted)]">Int</span>
                                                    <span className={cn(risk.integrity >= 4 && "text-red-400 font-bold")}>{risk.integrity}</span>
                                                </div>
                                                <div className="flex flex-col items-center">
                                                    <span className="text-[10px] uppercase text-[var(--text-muted)]">Avail</span>
                                                    <span className={cn(risk.availability >= 4 && "text-red-400 font-bold")}>{risk.availability}</span>
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            {isEditing ? (
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <span className={cn(
                                                        ...
                                                        risk.treatmentOption === "Mitigate" && "bg-blue-500/10 text-blue-400 border-blue-500/20",
                                                        risk.treatmentOption === "Avoid" && "bg-red-500/10 text-red-400 border-red-500/20",
                                                        risk.treatmentOption === "Transfer" && "bg-purple-500/10 text-purple-400 border-purple-500/20",
                                                        risk.treatmentOption === "Accept" && "bg-yellow-500/10 text-yellow-400 border-yellow-500/20",
                                                        !["Mitigate", "Avoid", "Transfer", "Accept"].includes(risk.treatmentOption) && "bg-gray-500/10 text-gray-400 border-gray-500/20"
                                                    )}>
                                        ...
                                        <td className="p-4 text-center">
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    risk.isResolved ? "bg-green-500/20 text-green-400 hover:bg-green-500/30" : "bg-[var(--bg-tertiary)] text-[var(--text-muted)] hover:text-[var(--text-primary)]"
                                                )}
                                            >
                                        ...
                                        <td className="p-4 text-right">
                                            <div className="flex items-center justify-end gap-1" onClick={e => e.stopPropagation()}>
                                                {isEditing ? (
                                                    <>
                                                        <button onClick={handleSave} disabled={isSaving} className="p-1.5 rounded bg-green-500/10 text-green-400 hover:bg-green-500/20">
                                                            {isSaving ? <Loader2 size={16} className="animate-spin" /> : <Save size={16} />}
                                                        </button>
                                                        <button onClick={handleCancelEdit} className="p-1.5 rounded bg-red-500/10 text-red-400 hover:bg-red-500/20">
                                                            <X size={16} />
                                                        </button>
                                                    </>
                                                ) : (
                                                    <button onClick={() => handleEdit(risk)} className="p-1.5 text-[var(--text-muted)] hover:text-blue-400 hover:bg-[var(--bg-elevated)] rounded transition-all">
                                                        <Edit2 size={16} />
                                                    </button>
                                                )}
                                            </div>
                                                    ...
                                                    <div className="col-span-12 md:col-span-5 space-y-4">
                                                        ...
                                                        <div className="space-y-3 pt-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="text-xs text-red-400 p-2 bg-red-500/5 rounded border border-red-500/10 font-mono">
